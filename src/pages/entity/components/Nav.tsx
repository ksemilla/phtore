...
import { ShoppingBagIcon, PhoneIcon, DevicePhoneMobileIcon } from "@heroicons/react/24/outline"
    ...
    <div className="sticky top-0 py-2">
      <div className="max-w-6xl m-auto py-1">
        <div className="flex justify-between items-center ">
          ...
          >
            <div
              className="aspect-video w-32 h-20 overflow-hidden rounded"
            > 
              <img
            ...
            <div className="flex items-center">
              <div>
                <h1 className="text-gray-800 text-lg hover:text-black font-medium cursor-pointer">{entity?.name}</h1>
